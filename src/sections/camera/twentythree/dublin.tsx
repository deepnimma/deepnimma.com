    ...
    return (
        <Grid2 container rowSpacing={-4} columnSpacing={3} columns={1}>
            <Grid2 xs display="flex" justifyContent={"center"} alignItems={"center"}>
                <Typography variant={"h4"} fontStyle="bold" fontFamily={"Bahnschrift, ui-monospace"}>October 25th - October 28th</Typography>
            </Grid2>
            <Grid2>
                    ...
                    <ImageList variant={"masonry"} cols={3} gap={8}>
                        {pic_names.map((num) => (
                            <ImageListItem key={num}>
                                <img
                                    src={require(`../../../data/portfolio/2023/dublin/${num}.jpg`)}
                                    alt={num}
                                    loading={"lazy"}
                                />
                            </ImageListItem>
